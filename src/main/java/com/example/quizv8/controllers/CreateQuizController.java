...
public class CreateQuizController {
    ...
    public String create(Model model, @RequestParam String quizName, @RequestParam long quizCategoryId, @RequestParam long stateId, @RequestParam String[] Question, @RequestParam String[] answerA,
        ...
        logger.info("Hello");
        QuizList quizList = new QuizList(quizName,false,0,userRepository.getById((long)session.getAttribute("uid")).get(),categoryRepository.getById(quizCategoryId),stateRepository.getById(stateId));
